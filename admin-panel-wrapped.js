(() => {
  ...
  var PlanificationContenus = () => {
    const [contenus, setContenus] = (0, import_react3.useState)({});
    const [niveauActif, setNiveauActif] = (0, import_react3.useState)("6\xE8me");
    const [trimestreActif, setTrimestreActif] = (0, import_react3.useState)("Trimestre 1");
    const [disciplineActive, setDisciplineActive] = (0, import_react3.useState)("Fran\xE7ais");
    const [vueActive, setVueActive] = (0, import_react3.useState)("planification");
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { background: "white", borderRadius: "15px", padding: "30px", boxShadow: "0 10px 30px rgba(0,0,0,0.1)" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginBottom: "30px" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "15px" }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, { icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { size: 20 }), titre: "En cours", valeur: stats.enCours, couleur: "#f4a261" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, { icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrendingUp, { size: 20 }), titre: "Termin\xE9s", valeur: stats.termines, couleur: "#6676ea" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, { icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, { size: 20 }), titre: "Total", valeur: stats.total, couleur: "#8e44ad" })
        ] })
      ] }),
  ...
  var AdminPanel = () => {
    const [activeTab, setActiveTab] = (0, import_react4.useState)("niveaux");
    const [niveaux, setNiveaux] = (0, import_react4.useState)([]);
    const [classes, setClasses] = (0, import_react4.useState)([]);
    const [matieres, setMatieres] = (0, import_react4.useState)([]);
    const [showAddNiveau, setShowAddNiveau] = (0, import_react4.useState)(false);
    const [showAddClasse, setShowAddClasse] = (0, import_react4.useState)(false);
    const [showAddMatiere, setShowAddMatiere] = (0, import_react4.useState)(false);
    const [editingItem, setEditingItem] = (0, import_react4.useState)(null);
    const [newNiveau, setNewNiveau] = (0, import_react4.useState)("");
    const [newClasse, setNewClasse] = (0, import_react4.useState)({ nom: "", niveauId: "" });
    const [newMatiere, setNewMatiere] = (0, import_react4.useState)({ nom: "", classeIds: [] });
  ...
  window.AdminPanel = pedaclic_admin_panel_default;
  var root = ReactDOM.createRoot(document.getElementById("root"));
  root.render(React.createElement(pedaclic_admin_panel_default));
})();

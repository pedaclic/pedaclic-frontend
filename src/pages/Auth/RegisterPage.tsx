...
const RegisterPage: React.FC = () => {
  ...
  /**
   * Inscription / connexion via Google avec le rôle sélectionné dans le formulaire
   */
      ...
      <div className="auth-container">
        ...
        <div className="auth-card auth-card--register">
          ...
          >
            {isGoogleLoading ? (
              <>
                <span className="auth-button-spinner auth-button-spinner--dark"></span>
                Création du compte…
              </>
            ) : (
              <>
          ...
          <p className="auth-google-hint">
            Le rôle sélectionné ci-dessus sera utilisé pour votre compte Google.
          </p>
